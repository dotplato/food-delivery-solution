        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card className="border-0  border-l-4 border-green-500 shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Image src="/images/revenue.png" alt="Revenue" width={80} height={80} />
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 border-l-4 border-blue-500 shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Image src="/images/orders.png" alt="Sales" width={80} height={80} />
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 border-l-4 border-orange-500 shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Image src="/images/products.png" alt="Products" width={80} height={80} />
            </CardHeader>
            <CardContent>
            ...
            <Card className="lg:col-span-1">
              <CardHeader>
                <div className="flex justify-between items-center">
                  ...
                  <Image src="/images/profit-chart.png" alt="Top Products" width={40} height={40} />
                </div>
              </CardHeader>
              <CardContent>
                {topProducts.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground text-center py-4">No products sold yet today.</p>
                )}
              </CardContent>
            </Card>
          </div>
              ...
              <TabsContent value="revenue">
                <div className="h-64 w-full">
                  <ChartContainer config={chartConfig} className="w-full h-full">
                    <AreaChart data={filteredChartData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                      ...
                      <YAxis dataKey="revenue" tickFormatter={(val) => `$${val}`} />
                      <ChartTooltip cursor={false} content={<ChartTooltipContent indicator="dot" />} />
                      <Area dataKey="revenue" type="monotone" fill="var(--color-revenue)" stroke="var(--color-revenue)" strokeWidth={2} />
                    </AreaChart>
                  </ChartContainer>
                </div>
              </TabsContent>
                ...
                <div className="h-64 w-full">
                  <ChartContainer config={chartConfig} className="w-full h-full">
                    <AreaChart data={filteredChartData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                      ...
                      <YAxis dataKey="sales" />
                      <ChartTooltip cursor={false} content={<ChartTooltipContent indicator="dot" />} />
                      <Area dataKey="sales" type="monotone" fill="var(--color-sales)" stroke="var(--color-sales)" strokeWidth={2} />
                    </AreaChart>
                  </ChartContainer>
                </div>
              </TabsContent>
