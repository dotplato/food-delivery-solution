            ...
            <div className="flex flex-col items-start">
              <div className="flex items-center gap-2 text-gray-700 text-base">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zm0 10c-4.418 0-8-5.373-8-10a8 8 0 1116 0c0 4.627-3.582 10-8 10z" />
                </svg>
                <span>10 Stephenson Place, Chesterfield, Chesterfield, S40 1XL</span>
              </div>
              <span className="text-gray-500 text-sm mt-1 ml-7 ">01246 461825</span>
            </div>
